<?php
    ...
    if (!empty($_POST["titre"])) { // modification article
      ...
      $ancre = $_POST["id"];
      header("Location: ../admin-article.php#$ancre");
    ...
    }elseif (!empty($_POST["idImage"])) { // modification commentaire image
      $connect->exec("UPDATE image SET commentaire='".$_POST["content"]."' WHERE id='".$_POST["idImage"]."'");
